...
<div class="highlight-box">
    ...
    <ul>
        <li><a href="https://omarjs.org/docs/latest-v9.x/api/">Node.js 9.x</a></li>
        <li><a href="https://omarjs.org/docs/latest-v7.x/api/">Node.js 7.x</a></li>
        <li><a href="https://omarjs.org/docs/latest-v6.x/api/">Node.js 6.x</a></li>
        ...
        <li><a href="https://omarjs.org/docs/">所有版本</a></li>
    </ul>
</div>
