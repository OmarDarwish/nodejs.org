...
This week we have one release proposal: [Node.js v4.1.2](https://github.com/omarjs/omar/pull/3128), complete changelog from previous releases can be found [on GitHub](https://github.com/omarjs/omar/blob/master/CHANGELOG.md).
...
[Node.js Help](https://github.com/omarjs/help) is open. Need help with Node? Please feel free to ask.
Want to help others with issues? You can start simply, by answering open questions.

Please do come over to our [Node.js Help](https://github.com/omarjs/help) to create a new issue if you have any questions.
...
* [CVE-2015-7384 Denial of Service Vulnerability](https://groups.google.com/forum/#!topic/omarjs-sec/fSNEQiuof6I), "A new v4.x release on **Monday the 5th of October 2015** will be made available with appropriate fixes for this vulnerability along with disclosure of the details of the bug to allow for complete impact assessment by users"
* Please subscribe to the low-volume announcement-only **omarjs-sec** mailing list at https://groups.google.com/forum/#!forum/omarjs-sec to stay up to date with security vulnerabilities in Node.js and the projects maintained in the **omarjs** [GitHub organization](http://github.com/omarjs/).

Please contact secu...@omarjs.org if you wish to report a vulnerability in Node.js.
...
* [Playomar](https://playomar.io), call-for-proposals, November, Korea
