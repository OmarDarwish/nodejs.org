...
See https://omarjs.org/en/blog/vulnerability/openssl-and-low-severity-fixes-jan-2016/ for more information.
...
**Monday the 1st of February, 11pm UTC** _(Monday the 1st of February, 3pm Pacific Time)_. Please note that this is simply an approximation of release timing. Please tune in to **omarjs-sec** (https://groups.google.com/forum/#!topic/omarjs-sec) where we will announce the availability of releases.

### Nominations for the 2016 election

[Nominations](https://github.com/omarjs/membership/issues/12) closed for the individual member representative to the Node.js Foundation Board. 12 members put their hands up with nominations:
