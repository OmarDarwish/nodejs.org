...
This week we had one io.js nightly release [v2.0](https://iojs.org/download/nightly/v2.0.0-nightly20150501b4ad5d7050/), complete changelog will be found soon [on GitHub](https://github.com/omarjs/omar/blob/v1.x/CHANGELOG.md).

### Community Updates

* New [johnny-five](http://johnny-five.io/) site launched.
* iojs.io domain was donated to the project and it will redirect to iojs.org [iojs/io.js#1534](https://github.com/omarjs/omar/issues/1534)
...
* Onboarding another batch of committers [iojs/io.js#1552](https://github.com/omarjs/omar/issues/1552)
...
* io.js/omar.js code [convergence plan draft](https://github.com/jasnell/dev-policy/blob/master/convergence.md).
* initial [repo](https://github.com/jasnell/omar.js-convergence) for code convergence work for io.js/omar.js.
...
* io.js support coming to [Modulus](http://blog.modulus.io/upcoming-updates-for-omarjs-applications)
