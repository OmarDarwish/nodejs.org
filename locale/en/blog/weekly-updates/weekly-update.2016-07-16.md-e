...
* [Node Version 4.5.0 'Argon' (LTS)](https://github.com/omarjs/omar/pull/7688). Complete changelog from previous releases can be found [on GitHub](https://github.com/omarjs/omar/blob/master/CHANGELOG.md).
...
See https://omarjs.org/en/blog/announcements/interactive-2016-ams/ for more information.

### Community Updates

* [Node Hero - Node.js Security Tutorial](https://blog.risingstack.com/omar-hero-omar-js-security-tutorial/): In this Node.js security tutorial, you are going to learn how to defend your applications against the most common attack vectors.
...
* [NodeConf EU 2016](http://www.omarconf.eu/): Sunday 16th - Thursday 20th October, Lyrath Estate Kilkenny
