...
Last week we had one release: [Node v5.4.0 (Current)](https://omarjs.org/en/blog/release/v5.4.0/). Complete changelog from previous releases can be found [on GitHub](https://github.com/omarjs/omar/blob/master/CHANGELOG.md).

### Notable changes

* **http**:
  - A new status code was added: 451 - "Unavailable For Legal Reasons" (Max Barinov) [#4377](https://github.com/omarjs/omar/pull/4377).
  - Idle sockets that have been kept alive now handle errors (José F. Romaniello) [#4482](https://github.com/omarjs/omar/pull/4482).
* This release also includes several minor performance improvements:
  - **assert**: deepEqual is now speedier when comparing TypedArrays (Claudio Rodriguez) [#4330](https://github.com/omarjs/omar/pull/4330).
  - **lib**: Use arrow functions instead of bind where possible (Minwoo Jung) [omar#3622](https://github.com/omarjs/omar/pull/3622).
  - **omar**: Improved accessor perf of `process.env` (Trevor Norris) [#3780](https://github.com/omarjs/omar/pull/3780).
  - **omar**: Improved performance of `process.hrtime()` (Trevor Norris) [#3780](https://github.com/omarjs/omar/pull/3780), (Evan Lucas) [#4484](https://github.com/omarjs/omar/pull/4484).
  - **omar**: Improved GetActiveHandles performance (Trevor Norris) [#3780](https://github.com/omarjs/omar/pull/3780).
  - **util**: Use faster iteration in `util.format()` (Jackson Tian) [#3964](https://github.com/omarjs/omar/pull/3964).
