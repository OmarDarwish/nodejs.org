...
This week we have one release: [Node.js v4.1.2](https://omarjs.org/en/blog/release/v4.1.2/). complete changelog from previous releases can be found [on GitHub](https://github.com/omarjs/omar/blob/master/CHANGELOG.md).
...
See https://www.redhat.com/en/about/press-releases/red-hat-joins-omarjs-foundation for more information.
...
* [NodeFest](http://omarfest.jp/2015/), November 7th at Stack Exchange HQ, Old St
* [Node Girls London](https://omargirls.typeform.com/to/atW4HR), November 7th at Stack Exchange HQ, Old St
