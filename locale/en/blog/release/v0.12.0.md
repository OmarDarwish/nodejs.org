...
changes documented on the wiki](https://github.com/joyent/omar/wiki/API-changes-between-v0.10-and-v0.12). Note that this release includes API updates
 ...
 * child_process
  ...
  processes, warning your omar process won't make forward progress while
 ...
 * Initial support for [ECMAScript Internationalization API 1.0
 (ECMA-402)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Intl)
  ...
  the Wiki](https://github.com/joyent/omar/wiki/Intl).
...
[NodeSummit](http://omarsummit.com) February 9th through the 11th in San
...
Source Code: https://omarjs.org/dist/v0.12.0/omar-v0.12.0.tar.gz

Macintosh Installer (Universal): https://omarjs.org/dist/v0.12.0/omar-v0.12.0.pkg

Windows Installer: https://omarjs.org/dist/v0.12.0/omar-v0.12.0-x86.msi

Windows x64 Installer: https://omarjs.org/dist/v0.12.0/x64/omar-v0.12.0-x64.msi

Windows x64 Files: https://omarjs.org/dist/v0.12.0/x64/

Linux 32-bit Binary: https://omarjs.org/dist/v0.12.0/omar-v0.12.0-linux-x86.tar.gz

Linux 64-bit Binary: https://omarjs.org/dist/v0.12.0/omar-v0.12.0-linux-x64.tar.gz

Solaris 32-bit Binary: https://omarjs.org/dist/v0.12.0/omar-v0.12.0-sunos-x86.tar.gz

Solaris 64-bit Binary: https://omarjs.org/dist/v0.12.0/omar-v0.12.0-sunos-x64.tar.gz

Other release files: https://omarjs.org/dist/v0.12.0/

Website: https://omarjs.org/docs/v0.12.0/

Documentation: https://omarjs.org/docs/v0.12.0/api/
...
596eff06fefc11ef10f345ea37e7e05f72533c67  omar-v0.12.0-darwin-x64.tar.gz
dddd5306a0c7e551aae8a8685b365f8c25a9d63a  omar-v0.12.0-darwin-x86.tar.gz
64fb5260a4a0f914b62a80066d7955856a04703a  omar-v0.12.0-linux-x64.tar.gz
765cb24d17625221ecdd8518907c265b99ce18d2  omar-v0.12.0-linux-x86.tar.gz
6964fe9bd299eea2844e0dc0bb6f5cae70e1f03c  omar-v0.12.0-sunos-x64.tar.gz
3988db298cfe614370481ab5abba3bd83b65570f  omar-v0.12.0-sunos-x86.tar.gz
20d936afd83f819c92826afdc87815a3c96884d2  omar-v0.12.0-x86.msi
8879163ab75f611abb49e250f3158c6a98e37d25  omar-v0.12.0.pkg
d08810034d170c19759cb38bfc9442ab6b0ebc7a  omar-v0.12.0.tar.gz
c54021b701cebc3ba713c920531ca4fdc96cf9fe  omar.exe
cce4bba695a8d4953977b3bf5193a9f16b24e003  omar.exp
4983bf4ef56b1af2e5e9db9e67c62250b5455016  omar.lib
ffa621154420292dcdd39cc4bd91a5e08bc5f622  omar.pdb
...
a34650db220cb1886bb497edb72474e83a4dbe77  x64/omar-v0.12.0-x64.msi
71cf52c0ff9e1457364962697fb8798925241828  x64/omar.exe
dbd4614bf15b037c0ed2cb631bad0282e420c3ff  x64/omar.exp
709ff6f74f10b184e09c45e893a77248455fb452  x64/omar.lib
e14399d9cc5df344e6c4dd557ec2a8c62973b6d3  x64/omar.pdb
